// src/lib.rs
/*
 * Core library for TypescriptDefinitions
 */
...
#[derive(Debug)]
pub struct TypescriptDefinitionsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TypescriptDefinitionsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TypescriptDefinitions processing");
    
    let mut processor = TypescriptDefinitionsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TypescriptDefinitionsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TypescriptDefinitionsProcessor::new(false);
